...
public class CommonPopupWindow extends PopupWindow {
    ...
    public interface ViewInterface {
        void getChildView(View view, int anchorId, int layoutResId);
    }
    ...
    public static class Builder {
        ...
        /*
        * @param view 设置AnchorId布局
        * @return Builder
        *
        * */
        public Builder setAnchorId(int anchorId){
        ...
        public CommonPopupWindow create() {
            ...
            if (listener != null && params.layoutResId != 0) {
                listener.getChildView(popupWindow.controller.mPopupView,anchorId, params.layoutResId);
            }
