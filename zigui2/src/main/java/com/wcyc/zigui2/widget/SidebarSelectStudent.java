 ...
 * @version 2.0
 */
public class SidebarSelectStudent extends View{
	private Paint paint;
	...
	public SidebarSelectStudent(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		NewSelectStudentAdapter adapter = (NewSelectStudentAdapter) mListView.getAdapter();
		System.out.println("setHeaderTextAndscroll");
