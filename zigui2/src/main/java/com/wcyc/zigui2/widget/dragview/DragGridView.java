...
public class DragGridView extends GridView {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                try {
                    ...
                    DataUtil.getToast("拖拽异常,请退出班级动态重试.");
                    e.printStackTrace();
                }
    ...
    private void dragItem(MotionEvent ev) {
        ...
        if (!isMove && isDrag) {
             ...
             * 者gridView外面）
             */
            if (dragCurrentPosition != lastDragPosition && dragCurrentPosition != -1 && dragCurrentPosition != lastVisiblePosition) {
                /**
                 * 动画是一个接着一个的，这里分开两张情况
                 *
                 * 一种是拖动到后面，另一种是拖动到前面
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (isLast) {
                    ...
                    ((DragGridAdapter) getAdapter()).moveItem(dragOriginPosition, dragCurrentPosition);//开始刷新item的新位置
     ...
     */
    public void setLongItemClick(final MotionEvent ev) {
