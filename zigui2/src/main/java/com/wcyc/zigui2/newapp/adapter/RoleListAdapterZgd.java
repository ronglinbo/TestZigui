...
public class RoleListAdapterZgd extends BaseAdapter{

	private List<Role> roles;
	private Context context;
	private int selectdPos;
	
	public RoleListAdapterZgd(Context context,List<Role> roles){
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1 == null){
			...
			arg1 = LayoutInflater.from(context).inflate(R.layout.roles_item_zgd, arg2, false);
