...
public class QianPayOrderFragment extends BaseRecyleviewFragment<Order> {
    private String type = "";
    private List<Order> mData = new ArrayList<>();

    int countB = 0;

    public  interface ChangeQianPayNumber{
        void setQianPay(int num);
    }
...
//        //绑定适配器数据
//        RelativeLayout shifu_rl = (RelativeLayout) holder.getView(R.id.shifu_rl); //欠款
