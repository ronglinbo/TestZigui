...
public class NewConsumeRecordActivity extends BaseActivity implements
		OnClickListener {
	...
	private void initDatas() {
		...
		try {
			...
			//网络是否可用
			if (!DataUtil.isNetworkAvailable(NewConsumeRecordActivity.this)) {
	...
	public void onClick(View v) {
		...
		case R.id.title_back:
			NewConsumeRecordActivity.this.finish();
			break;
		default:
			break;
