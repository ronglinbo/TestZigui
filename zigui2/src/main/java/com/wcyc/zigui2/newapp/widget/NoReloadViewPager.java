 ...
 */
public class NoReloadViewPager extends ViewGroup {
    private static final String TAG = "NoReloadViewPager";
    ...
    public NoReloadViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public NoReloadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
