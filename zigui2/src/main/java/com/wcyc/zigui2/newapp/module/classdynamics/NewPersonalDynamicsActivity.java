...
public class NewPersonalDynamicsActivity extends BaseActivity implements
    ...
    private static final int REQUEST_DELETE_ITEM_CODE = 10000;
    ...
    private void initEvents() {
        ...
        personal_list.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                startActivityForResult(intent, REQUEST_DELETE_ITEM_CODE);
//                startActivity(intent);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        dismissPd();
        switch (requestCode) {
            case REQUEST_DELETE_ITEM_CODE:
                if (resultCode == RESULT_OK) {
//                    setResult(RESULT_OK);
                    //重新加载
                    requestClassList();

                    //通知NewClassDynamicsActivity 刷新数据
                    Intent intent = new Intent(NewClassDynamicsActivity.INTENT_REFESH_DATA);
                    intent.putExtra("RefreshDeleteData",true);
