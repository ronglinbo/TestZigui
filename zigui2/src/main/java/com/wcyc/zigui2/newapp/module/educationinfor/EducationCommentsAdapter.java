...
public class EducationCommentsAdapter extends BaseAdapter {
	private Context mContext;
	private List<EducationCommentBean> data_list;

	public EducationCommentsAdapter(Context mContext,
									List<EducationCommentBean> data_list) {
		super();
	...
	// 添加更多数据
	public void addItem(List<EducationCommentBean> i) {
		 data_list.addAll(i);
	}
}