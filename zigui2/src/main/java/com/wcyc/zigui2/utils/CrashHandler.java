...
//    private String nameString = "zigui_crash";
//
...
////        CCApplication.getInstance().getSpUtil().setCrashLog(true);// 每次进入应用检查，是否有log，有则上传
//        // 使用Toast来显示异常信息
//        new Thread() {
//            @Override
//            public void run() {
...
//                String path = Environment.getExternalStorageDirectory()+"/ZIGUI/";
...
//                fos.close();
//                Log.i(TAG,"file saved:"+path+fileName);
//            }
//            return fileName;
//        } catch (Exception e) {
...
//                UploadUtil.uploadFile(file, Constants.BASE_URL);
//            }
//        }catch(Exception e){
//            e.printStackTrace();
//        }
