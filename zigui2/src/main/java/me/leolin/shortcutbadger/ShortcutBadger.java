...
public abstract class ShortcutBadger {
    ...
    //小米手机
    private static final String HOME_PACKAGE_MIUI = "com.miui.home";
    private static final String HOME_PACKAGE_HUAWEI = "com.huawei.android.launcher";
...
//            mShortcutBadger = new hTCHomeBadger(context);
        ...
        } else if (HOME_PACKAGE_MIUI.equals(currentHomePackage)) {
            mShortcutBadger = new MiuiHomeBadger(context);
        } else if(HOME_PACKAGE_HUAWEI.equals(currentHomePackage)){
            mShortcutBadger = new HuaweiHomeBadger(context);
        } else if(Build.MANUFACTURER.equalsIgnoreCase("OPPO")){
            mShortcutBadger = new OppoHomeBadger(context);
        } else if(Build.MANUFACTURER.equalsIgnoreCase("VIVO")){
            mShortcutBadger = new VivoHomeBadger(context);
        }else{
