...
//		new LoadConfigTask().execute();
        ...
        //使用SDK加密串来配置
        client.setConfig("5LRvSl9xppuvHXYX4pc/7hwlLqoH67i13aiXKW13nHlnHj//oEUlWJ6bwwf2UgLYTBgK0cMDiYPOUlcIfH5viHq2IkCVCfrIzaG2X4pX1tvhCEubSjjhjgl/QIvnHho1/vjS6AWZdNWPKlmntJIdUA==", aeskey, iv, getApplicationContext());
        //初始化SDK设置
...
//		client.crashReportSetUserId(userId);
        ...
        String vid = "8a33c4f778c6dc32e8a214e7b7c16a2d_8";
